-- Telegram notifications for Kristina's English Space.
-- Run once in Supabase Dashboard -> SQL Editor.
-- The known destination chat is registered directly, so no Telegram linking webhook is needed.
...
-- Server-only tables: the browser cannot read or change Telegram recipients/logs.
...
-- Register the destination supplied by the teacher.
insert into public.telegram_recipients (student_id, chat_id, enabled)
values ('kristina', -1003987027739, true)
